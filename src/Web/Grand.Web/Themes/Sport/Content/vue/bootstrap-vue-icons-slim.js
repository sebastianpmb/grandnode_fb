...
(a = this),
    (l = function (a) {
        ...
        function o(a, e) {
            ...
            for (var l = 0, t = new Array(e); l < e; l++) t[l] = a[l];
            return t;
        }
        var c = function () {
            return (c =
                Object.assign ||
                function (a) {
                    for (var e, l = 1, t = arguments.length; l < t; l++) for (var n in (e = arguments[l])) Object.prototype.hasOwnProperty.call(e, n) && (a[n] = e[n]);
                    return a;
        ...
        function u(a) {
            for (var e, l = {}, t = 0, n = a.split(h); t < n.length; t++) {
                var r = n[t].split(d),
                    o = r[0],
                    c = r[1];
                (o = o.trim()) && ("string" == typeof c && (c = c.trim()), (l[((e = o), e.replace(i, v))] = c));
            }
            return l;
        }
        function f() {
            for (var a, e, l = {}, t = arguments.length; t--;)
                for (var n = 0, r = Object.keys(arguments[t]); n < r.length; n++)
                    switch ((a = r[n])) {
                        case "class":
                        case "style":
                        case "directives":
                            if ((Array.isArray(l[a]) || (l[a] = []), "style" === a)) {
                                var o = void 0;
                                o = Array.isArray(arguments[t].style) ? arguments[t].style : [arguments[t].style];
                                for (var i = 0; i < o.length; i++) {
                                    var d = o[i];
                                    "string" == typeof d && (o[i] = u(d));
                                }
                                arguments[t].style = o;
                            }
                            l[a] = l[a].concat(arguments[t][a]);
                            break;
                        case "staticClass":
                            if (!arguments[t][a]) break;
                            void 0 === l[a] && (l[a] = ""), l[a] && (l[a] += " "), (l[a] += arguments[t][a].trim());
                            break;
                        case "on":
                        case "nativeOn":
                            l[a] || (l[a] = {});
                            for (var h = 0, v = Object.keys(arguments[t][a] || {}); h < v.length; h++) (e = v[h]), l[a][e] ? (l[a][e] = [].concat(l[a][e], arguments[t][a][e])) : (l[a][e] = arguments[t][a][e]);
                            break;
                        case "attrs":
                        case "props":
                        case "domProps":
                        ...
                        case "hook":
                        case "transition":
                            l[a] || (l[a] = {}), (l[a] = c({}, arguments[t][a], l[a]));
                            break;
                        case "slot":
                        case "key":
                        case "ref":
        ...
        var s,
            ...
            A = V && H && M,
            L = V ? window : {},
            y = ((M ? navigator : {}).USER_AGENT || "").toLowerCase(),
            C = y.indexOf("jsdom") > 0,
            b =
                (/msie|trident/.test(y),
                    (function () {
                        if (A)
                            try {
                                var a = { get passive() { } };
                                L.addEventListener("test", a, a), L.removeEventListener("test", a, a);
                            } catch (a) { }
                    })(),
                    A && "IntersectionObserver" in L && "IntersectionObserverEntry" in L && L.IntersectionObserverEntry.prototype,
                    /\B([A-Z])/g),
            B = /-(\w)/g,
            g = /^BIcon/,
            I = function (a) {
            ...
            P = function (a, e) {
                return j(a)
                    ...
                    .reduce(function (e, l) {
                        return r(r({}, e), {}, t({}, l, a[l]));
                    }, {});
            },
            F = function a(e) {
                var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e;
                return w(e)
                    ? e.reduce(function (e, l) {
                        return [].concat(
                            (function (a) {
                                return (
                                    (function (a) {
                                    ...
                                    (function (a, e) {
                                        if (a) {
                                            ...
                                            return (
                                                ...
                                                "Map" === l || "Set" === l ? Array.from(a) : "Arguments" === l || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(l) ? o(a, e) : void 0
                                            );
                                        }
                                    })(a) ||
                                    (function () {
                    ...
                    : E(e)
                        ? j(e).reduce(function (l, n) {
                            return r(r({}, l), {}, t({}, n, a(e[n], e[n])));
                        }, {})
                        : l;
            },
            x = function (a) {
            ...
            T = function (a) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                    l = ("undefined" != typeof process && process && process.env) || {};
                return a ? l[a] || e : l;
            },
            N =
                ((s = !1),
                    (p = ["Multiple instances of Vue detected!", "You may need to set up an alias for Vue in your bundler config.", "See: https://bootstrap-vue.org/docs#using-module-bundlers"].join("\n")),
                    function (a) {
                        s ||
                            e.default === a ||
                            C ||
                            (function (a) {
                                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                                T("BOOTSTRAP_VUE_NO_WARN") || "production" === T("NODE_ENV") || console.warn("[BootstrapVue warn]: ".concat(e ? "".concat(e, " - ") : "").concat(a));
                            })(p),
                            (s = !0);
                    }),
            D = function () {
                var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    t = a.plugins,
                    n = function a(n) {
                        a.installed || ((a.installed = !0), N(n), X(n, e), _(n, l), G(n, t));
                    };
                return (n.installed = !1), n;
            },
            R = function () {
                var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                return r(r({}, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}), {}, { install: D(a) });
            },
            G = function (a) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                for (var l in e) l && e[l] && a.use(e[l]);
            },
            U = function (a, e, l) {
                a && e && l && a.component(e, l);
            },
            X = function (a) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                for (var l in e) U(a, l, e[l]);
            },
            $ = function (a, e, l) {
                a && e && l && a.directive(e.replace(/^VB/, "B"), l);
            },
            _ = function (a) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            ...
            Q = String,
            J = [q, Q],
            Y = e.default.prototype,
            Z = function (a) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : void 0,
                    l = Y.$bvConfig;
                return l ? l.getConfigValue(a, e) : F(e);
            },
            K = function (a) {
            ...
            ea = function (a) {
                return (function (a) {
                    ...
                    return k(a) ? "" : w(a) || (E(a) && a.toString === Object.prototype.toString) ? JSON.stringify(a, null, e) : String(a);
                })(a).trim();
            },
            la = function () {
                var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0,
                    ...
                    t = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : void 0,
                    n = !0 === l;
                return (
                    (t = n ? t : l),
                    r(
                    ...
                    {},
                    {
                        default: function () {
                            var t = (function (a) {
                                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                                    l = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
                                return e ? Z("".concat(a, ".").concat(e), l) : Z(a, {});
                            })(l, e, a.default);
                            return S(t) ? t() : t;
                        },
                    }
            ...
            na = function (a, e) {
                return j(a).reduce(function (l, n) {
                    return r(r({}, l), {}, t({}, n, ta(a[n], n, e)));
                }, {});
            },
            ra = (ta({}, "", "").default.name, "BIcon"),
            oa = "BIconstack",
            ca = Math.max,
            ia = function (a) {
            ...
            va = { animation: la(Q), content: la(Q), flipH: la(W, !1), flipV: la(W, !1), fontScale: la(J, 1), rotate: la(J, 0), scale: la(J, 1), shiftH: la(J, 0), shiftV: la(J, 0), stacked: la(W, !1), title: la(Q), variant: la(Q) },
            ua = e.default.extend({
                name: "BIconBase",
                functional: !0,
                props: va,
                render: function (a, e) {
                    var l,
                        ...
                        u = r.title,
                        s = r.variant,
                        p = ca(ia(r.fontScale, 1), 0) || 1,
                        z = ca(ia(r.scale, 1), 0) || 1,
                        m = ia(r.rotate, 0),
                        V = ia(r.shiftH, 0),
                        H = ia(r.shiftV, 0),
                        M = d || h || 1 !== z,
                        ...
                        C = a(
                            "g",
                            {
                                attrs: {
                                    transform:
                                        [A ? "translate(8 8)" : null, M ? "scale(".concat((d ? -1 : 1) * z, " ").concat((h ? -1 : 1) * z, ")") : null, m ? "rotate(".concat(m, ")") : null, A ? "translate(-8 -8)" : null]
                                            .filter(x)
                                            .join(" ") || null,
                                },
                                domProps: y ? { innerHTML: i || "" } : {},
                            },
                            o
                        );
                    L && (C = a("g", { attrs: { transform: "translate(".concat((16 * V) / 16, " ").concat((-16 * H) / 16, ")") } }, [C])), v && (C = a("g", {}, [C]));
                    var b = u ? a("title", u) : null;
                    return a(
                        "svg",
                        f(
                            { staticClass: "b-icon bi", class: ((l = {}), t(l, "text-".concat(s), s), t(l, "b-icon-animation-".concat(c), c), l), attrs: da, style: v ? {} : { fontSize: 1 === p ? null : "".concat(100 * p, "%") } },
                            n,
                            v ? { attrs: ha } : {},
                            { attrs: { xmlns: v ? null : "http://www.w3.org/2000/svg", fill: "currentColor" } }
                        ),
                        [b, C]
                    );
                },
            ...
            fa = function (a, l) {
                ...
                return e.default.extend({
                    name: n,
                    functional: !0,
                    props: r(r({}, P(va, ["content", "stacked"])), {}, { stacked: la(W, !1) }),
                    render: function (a, e) {
                        var l = e.data,
                            t = e.props;
                        return a(ua, f({ props: { title: c }, attrs: { "aria-label": c } }, l, { staticClass: o, props: r(r({}, t), {}, { content: i }) }));
                    },
                });
            },
            sa = fa("Blank", ""),
            ...
            Ba = fa("Exclamation", '<path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>'),
            ga = fa(
                "ClipboardPlus",
            ...
            Pa = fa("DoorClosed", '<path fill-rule="evenodd" d="M3 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v13h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V2zm1 13h8V2H4v13z"/><path d="M9 9a1 1 0 1 0 2 0 1 1 0 0 0-2 0z"/>'),
            Fa = fa(
                "Gear",
            ...
            Qa = fa("ChevronLeft", '<path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>'),
            Ja = fa(
                "ShieldLock",
            ...
            se = fa("Moon", '<path fill-rule="evenodd" d="M14.53 10.53a7 7 0 0 1-9.058-9.058A7.003 7.003 0 0 0 8 15a7.002 7.002 0 0 0 6.53-4.47z"/>'),
            pe = fa(
                "Sun",
            ...
            He = na(
                ((z = r(r({}, P(va, ["content", "stacked"])), {}, { icon: la(Q), stacked: la(W, !1) })),
                    j(z)
                        .sort()
                        .reduce(function (a, e) {
                            return r(r({}, a), {}, t({}, e, z[e]));
                        }, {})),
                ra
            ),
            Me = e.default.extend({
                ...
                render: function (a, e) {
                    var l = e.data,
                        t = e.props,
                        n = e.parent,
                        o = aa(ea(t.icon || "")).replace(g, "");
                    return a(
                        (o &&
                            (function a(e, l) {
                                return e ? (e.$options || {}).components[l] || a(e.$parent, l) : null;
                            })(n, "BIcon".concat(o))) ||
                        sa,
                        f(l, { props: r(r({}, t), {}, { icon: null }) })
                    );
                },
            }),
            Ae = na(P(va, ["content", "stacked"]), oa),
            Le = R(
                {
                    plugins: {
                        IconsPlugin: R({
                            components: {
                                ...
                                BIconstack: e.default.extend({
                                    ...
                                    render: function (a, e) {
                                        var l = e.data,
                                            t = e.props,
                                            n = e.children;
                                        return a(ua, f(l, { staticClass: "b-iconstack", props: r(r({}, t), {}, { stacked: !1 }) }), n);
                                    },
                                }),
                                BIconBlank: sa,
                                BIconCalendar2Check: pa,
                                BIconSearch: za,
                                BIconTrash: ma,
                                BIconEnvelope: Va,
                                BIconHandThumbsDown: Ha,
                                BIconHandThumbsUp: Ma,
                                BIconHouseDoor: Aa,
                                BIconList: La,
                                BIconGrid3x2Gap: ya,
                                BIconGrid3x2GapFill: Ca,
                                BIconXCircleFill: ba,
                                BIconExclamation: Ba,
                                BIconClipboardPlus: ga,
                                BIconServer: Ia,
                                BIconX: ka,
                                BIconHeart: Sa,
                                BIconHammer: wa,
                                ...
                                BIconCartCheck: Da,
                                BIconPerson: Ra,
                                BIconFileEarmarkRichtext: Ga,
                                BIconFileEarmarkEasel: Ua,
                                BIconFileEarmarkFont: Xa,
                                BIconFileEarmarkCheck: $a,
                                BIconArrowReturnLeft: _a,
                                BIconCloudDownload: Wa,
                                BIconSkipBackward: qa,
                                BIconChevronLeft: Qa,
                                BIconShieldLock: Ja,
                                BIconTrophy: Ya,
                                BIconPersonCircle: Za,
                                BIconFileRuled: Ka,
                                BIconShop: ae,
                                BIconStar: ee,
                                BIconStarFill: le,
                                ...
                                BIconCartX: ce,
                                BIconCart2: ie,
                                BIconLayoutSidebarInset: de,
                                BIconArrowClockwise: he,
                                BIconFileEarmarkLock2: ve,
                                BIconFileEarmarkRuled: ue,
                                BIconAspectRatio: fe,
                                BIconMoon: se,
                                BIconSun: pe,
                                BIconClockHistory: ze,
                                BIconPhone: me,
                                BIconBuilding: Ve,
                                BIconArrowsFullscreen: bl,
                            },
                        }),
                    },
                },
        ...
        return (m = Le), V && window.Vue && window.Vue.use(m), V && m.NAME && (window[m.NAME] = m), Le;
    }),
